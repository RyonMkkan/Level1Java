...
public class SimonSaysRecipe extends KeyAdapter {
 ...
 JOptionPane.showMessageDialog(null, "Press the matching key when simon says, otoherwise press a different key");
 ...
 Ryon = new JFrame(); 
	...
	Ryon.setVisible(true);
  	 //frame.add(getNextRandomImage()); //7. rename to the name of your frame
    	Ryon.add(getNextRandomImage());
    	// 8. set the size of the frame 
     	Ryon.setSize(500, 250);
    	// 9. add a key listener to the frame
	Ryon.addKeyListener(this);
